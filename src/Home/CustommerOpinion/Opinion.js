...
const Opinion = () => {
  return (
    <section className="mt-16 bg-slate-300 rounded-lg">
      <div className="container mx-auto flex flex-col items-center pb-6 mb-4 md:p-10 md:px-12">
        <h1 className="text-4xl font-semibold leading-none text-center text-[#293462]">
        ...
        <div className="flex flex-col items-center mx-12 lg:mx-0">
          <div className="relative text-center">
            ...
            <p className="px-6 py-1 text-lg italic">
              Very easy to find product. User experience is just awesome.
              Their dealing process is very friendly.
            </p>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 512 512"
